...
<h3>나. 동기와 목적</h3>
<p>지난해 범정부 공공데이터 활용 경진대회에서는 국립국악원의 국악 음원을 AI와 결합한 작품이 대통령상을 받았습니다. 문화 분야 공공데이터와 AI를 결합한 접근이 이미 성과를 낸 사례이며, K-Rosetta는 같은 접근을 문화용어 번역에 적용합니다. 활용되지 않던 외교부 산하기관 공공데이터를 번역에 적용하여, 한국 문화가 여러 언어로 정확히 전달되도록 하고 한국 콘텐츠 현지화의 품질을 높이는 것이 목적입니다.</p>

<h2>2. 아이디어 핵심 기술, 기능, 구성 및 특징</h2>
<h3>가. 핵심 처리 방식</h3>
...
<h2>4. 아이디어 실현 가능성</h2>
<h3>가. 아이디어의 구현 및 실현 가능성</h3>
<p>K-Rosetta는 계획 단계에 머문 아이디어가 아니라, 이미 동작하는 시제품으로 구현되어 있습니다.</p>
<ul>
...
<h3>나. 아이디어의 시장성 및 실제 사업 가능성, 활용성</h3>
...
<tr><td>상생협력</td><td>전문 번역가를 대체하지 않고 용어 검수를 자동화해 생산성을 높입니다. 번역가는 반복적인 용어 확인에서 벗어나 문장의 완성도에 집중할 수 있습니다.</td></tr>
<tr><td>일자리 창출</td><td>문화용어 데이터를 정리·관리하는 새로운 직무가 생기며, 서비스가 확장될수록 용어 큐레이션·품질 검수 인력 수요도 늘어납니다.</td></tr>
<tr><td>공공외교 기여</td><td>한국 문화가 여러 언어권에 정확하게 전달되어, 왜곡 없는 문화 소개에 기여합니다.</td></tr>
<tr><td>공공데이터 활용</td><td>활용되지 않던 산하기관 데이터를 번역에 적용한 사례이며, 문화용어 평가 자료를 공공에 환원합니다.</td></tr>
