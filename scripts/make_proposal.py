...
<p>이 결과는 전량 공공데이터와 「Koreana」 관례를 바탕으로 구축한 자료에서 나온 것입니다. 현재 수록된 문화·전문 용어는 1,211개(한국음식정보 691개, 개발협력 용어 393개, 문화용어 93개, 해외대학 기관명 34개)이며, 이를 여러 언어로 옮긴 표준 대역이 1,643개입니다. 번역과 답변의 근거로 삼는 문서는 1,542건이고, 이 가운데 480건이 「Koreana」 기사입니다.</p>
