...
<tr><td><b>B2G</b><br>(교두보)</td><td>국립박물관·국가유산청·한국관광공사·재외문화원·세종학당</td><td>다국어 안내·전시·문화유산 표기의 오역이 국가 이미지에 직결. 정확성 책임과 번역 예산을 이미 보유</td><td>사업 수주(조달 등록)·연간 구독</td></tr>
...
<p class="small">진입 논리: 정확성이 <b>의무이자 예산이 있는</b> 공공 부문(B2G)을 먼저 확보해 신뢰 레퍼런스를 만들고, 이를 지렛대로 대량 현지화 수요가 있는 민간(B2B)으로 확장합니다. B2C는 처음부터 무료로 공개해 사용 데이터와 브랜드를 축적합니다. 넷플릭스 등 대형 OTT는 직접 계약보다 <b>자막 납품 벤더를 경유하는 B2B 경로</b>가 현실적 진입점입니다.</p>
...
<h3>나. 경쟁 우위와 진입장벽</h3>
<ul>
<li><b>데이터 해자:</b> 공공데이터 공인 표준과 한국국제교류재단의 39년 다국어 코퍼스는 후발 주자가 단기간에 복제하기 어렵습니다.</li>
