...
<p class="chg"><b>창업(사업화) 계획 — 예비창업자</b></p>
<p class="chg">본 참가자는 예비창업자로서, 이미 동작하는 K-Rosetta 시제품을 상용 서비스로 발전시켜 창업합니다. 실행 단계는 다음과 같습니다.</p>
<table class="chg">
<tr><th style="width:24%">단계</th><th>내용</th></tr>
<tr><td>1단계 (착수~6개월)<br>창업 준비·초기 자금</td><td>법인을 설립하고 예비창업패키지·청년창업사관학교 등 정부 창업지원사업에 지원해 초기 개발·운영 자금을 확보합니다. 이미 동작하는 시제품이 있어 선정에 유리합니다.</td></tr>
<tr><td>2단계 (착수~9개월)<br>첫 도입 실적 확보</td><td>정확성이 반드시 필요한 공공기관(국립박물관·한국관광공사·재외문화원)에 무상 또는 저가로 파일럿을 제공해 첫 도입 실적과 사용 확인서를 확보하고, 이를 영업·투자의 근거로 삼습니다.</td></tr>
<tr><td>3단계 (6~12개월)<br>상용 제품화</td><td>현재의 데모를 상용 서비스로 전환합니다. 클라우드 배포, 이용자 계정·과금 체계, API 문서화, 용어사전 500개 이상 확대, 라이브 번역 엔진 연동을 완료합니다.</td></tr>
<tr><td>4단계 (1년차)<br>수익화</td><td>웹툰·자막·번역업체를 대상으로 용어 검수 API·구독을 유료로 출시해 첫 매출을 만들고, 문화용어 다국어 데이터 라이선스로 수익원을 넓힙니다.</td></tr>
<tr><td>5단계 (1~2년차)<br>성장·투자 유치</td><td>공공 도입 실적과 초기 매출을 근거로 시드 투자 또는 정부 R&D를 유치하고, 글로벌 진출 지원사업과 연계해 저자원 언어권 시장으로 확장합니다.</td></tr>
</table>
<p><b>경쟁 우위</b></p>
<ul>
